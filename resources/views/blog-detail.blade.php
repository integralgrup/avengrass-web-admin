            ...
            <div class="wrapper h-full">
                <div class="carousel-field relative h-full rounded-[30px] overflow-hidden">
                    <div class="content relative h-full">
                        ...
                        <div class="image group/image group/popup relative h-full overflow-hidden rounded-20 cursor-pointer translate-z-0" href="<?= env('HTTP_DOMAIN') . '/' . $blogUrl .'/'. $blog->seo_url ?>" 
                                    ...
                                    md:group-[&.swiper-slide-active]/slide:translate-y-0">
                                        <div class="content pl-60 lg:pl-40 md:pl-30 sm:pl-0 relative group-[&.swiper-slide-active]/slide:pl-0">
                                            ...
                                            <div class="image-field rounded-[15px] overflow-hidden">
                                                <?php $item->news == 1 ? $blogUrl = getUrl('news_url', app()->getLocale()) : $blogUrl = getUrl('blog_url', app()->getLocale()); ?>
                                                <a href="<?= env('HTTP_DOMAIN') . '/' . $blogUrl .'/'. $item->seo_url ?>" class="image h-325 xs:h-250 sm:h-275 md:h-300 overflow-hidden translate-z-0 flex w-full hover:scale-110 duration-450">
                                            ...
                                            <div class="text-field mt-30 md:mt-20">
                                                ...
                                                <a href="<?= env('HTTP_DOMAIN') . '/' . $blogUrl .'/'. $item->seo_url ?>" class="title flex text-28 xl:text-26 lg:text-24 md:text-22 sm:text-20 xs:text-18 leading-tight text-[#111111] duration-450 hover:text-main-500 font-semibold mt-20 md:mt-15 group-hover/slide:text-main-500 group-hover/slide:hover:text-main-600"><?= $item['title'] ?></a>
