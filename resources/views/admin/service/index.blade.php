...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Servis Listesi</h3></div>
              <div class="col-sm-6">
                            ...
                            <tbody>
                                @foreach($services as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.service.edit', $item->service_id) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <form action="{{ route('admin.service.destroy', $item->service_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
