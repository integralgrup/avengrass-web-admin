...
<main class="main-field">
    <!-- BREADCRUMB -->
    <?php $title = 'USING AREAS';
    $expo = 'Where Excellence Turns Green!';
    $navigation = ['Home' => 'index.php', 'Other' => 'javascript:;', 'Using Areas' => 'javascript:;']; ?>
    ...
    <!-- CONTENT -->
    <section class="using-areas-section py-120 xl:py-80 lg:py-60 md:py-45 sm:py-30 relative overflow-hidden">
        <!-- LEFT LOGO -->
        ...
        <div class="container max-w-[1500px] relative z-20">
            <div class="wrapper">
                ...
                <!-- USING AREAS CONTENT -->
                <div class="service-wrapper grid grid-cols-1 gap-[50px] srb-short-all">
                        ...
                        <div class="service-item item group/item relative show-button-anim">
                            <div class="content bg-[#F6F6F6] rounded-[15px] overflow-hidden relative grid grid-cols-2 gap-0 md:grid-cols-1 border border-solid border-transparent group-hover/item:border-main-500 duration-450 group-[&.is-active]/item:border-main-500">
                                <div class="image-box h-[400px] xs:h-250 sm:h-300 md:h-350 lg:h-375 overflow-hidden">
                                    <a href="<?=env('HTTP_DOMAIN') .'/'. getUrl('using_areas_url').'/'. $item['seo_url']?>" class="image flex w-full h-[400px] xs:h-250 sm:h-300 md:h-350 lg:h-375 overflow-hidden translate-z-0 duration-450 group-hover/item:scale-110">
                                        <img src="<?= env('HTTP_DOMAIN') .'/'. getFolder(['uploads_folder', 'using_areas_images_folder'], $item['lang']) .'/'. $item['image'] ?>" class="full-cover" loading="lazy" alt="">
                                    </a>
                                </div>
                                <div class="text-field flex flex-col justify-center p-60 lg:p-45 md:p-30 sm:p-25 gap-[20px] lg:gap-[15px] md:gap-[15px]">
                                    <a href="<?=env('HTTP_DOMAIN') .'/'. getUrl('using_areas_url').'/'. $item['seo_url']?>" class="title text-34 xl:text-30 lg:text-28 md:text-24 sm:text-20 text-black leading-tight font-bold duration-450 hover:text-main-500 hover:translate-x-[5px] group-[&.is-active]/item:text-main-500 group-[&.is-active]/item:hover:text-main-600"><?= $item->title; ?></a>
