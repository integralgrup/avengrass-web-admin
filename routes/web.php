...
Route::post('/admin/service/store', 'App\Http\Controllers\Admin\ServiceController@store')->name('admin.service.store');
...
//image copy route
Route::get('/copy-image', 'App\Http\Controllers\HomeController@image_copy')->name('copy.image');
